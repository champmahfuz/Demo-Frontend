...
const FlightCardsv3 = ({ itinerariesData, data }) => {
                        ...
                        <Grid item xs={ 12 } sm={ 12 } md={ 4 } lg={ 4 }>
                            <Grid container sx={ {
                                ...
                                <Grid item xs={ 9 }>
                                    ...
                                    <Button variant="contained" onClick={ handleBooking }><Link style={ { background: 'transparent' } } to={ `/Booking` }>Book Now</Link></Button>
                                </Grid>
